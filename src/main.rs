...
fn main() {
    solve_str!(year2024, day16);
    solve_str!(year2024, day1);
    solve_str!(year2023, day23);
    solve_str!(year2023, day22);
    solve_str!(year2023, day21);
    solve_str!(year2023, day20);
    solve_str!(year2023, day19);
    solve_str!(year2023, day18);
    solve_str!(year2023, day17);
    solve_str!(year2023, day16);
    solve_str!(year2023, day15);
    solve_str!(year2023, day14);
    solve_str!(year2023, day13);
    solve_str!(year2023, day12);
    solve_str!(year2023, day11);
    solve_str!(year2023, day10);
    solve_str!(year2023, day9);
    solve_str!(year2023, day8);
    solve_str!(year2023, day7);
    solve_str!(year2023, day6);
    solve_str!(year2023, day5);
    ...
    solve_str!(year2015, day11);
    solve_str!(year2015, day9);
    solve_str!(year2015, day8);
    solve_str!(year2015, day7);
    solve_str!(year2015, day6);
    solve_str!(year2015, day5);
    solve_str!(year2015, day4);
    solve_str!(year2015, day3);
    solve_str!(year2015, day2);
