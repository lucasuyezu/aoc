...
fn main() {
    let t2020_03 = thread::spawn(|| {
        let lines = year2020::get_lines("/Users/lucasuyezushopify/src/github.com/lucasuyezu/aoc/src/year2020/day3/input");
        ...
        let t2 = thread::spawn(move || {
            ...
            println!("Year 2020 Day 3 Part 2 result is {}", result_1 * result_2 * result_3 * result_4 * result_5);
        });
    ...
    t2020_03.join().expect("Year 2020 Day 3 thread has panicked!");
